...
daily_activity = pd.read_csv("C:/Users/Pallavi Mishra/OneDrive/Documents/dv data/Fitabase Data 4.12.16-5.12.16/dailyActivity_merged.csv")
...
plt.hist(df_activity.day_of_the_week, bins = 7, 
         width = 0.6, color = "lightgreen", edgecolor = "black")
...
colours = ["lightcoral", "yellowgreen", "yellow", "orange"]
explode = [0, 0, 0, 0.1]
plt.style.use("default")
